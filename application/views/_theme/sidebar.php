...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
            ...
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li role="seperator" class="divider"></li>
                        <li><a href="<?php echo base_url("welcome/logout"); ?>"><i class="material-icons">input</i>Çıkış Yap</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2016 <a target="_blank" href="http://yunuskorkmaz.net">Yunus Korkmaz</a>.
            </div>
